...
setTimeout(function(){
  ...
  $('#preview-monogram').on('click', function (el) {
    ...
    threadcolor1 = $("#threadcolor1 option:selected").attr("data-valcolor");
    ...
    if (MonogramFont.indexOf("DTGGucciMIY")  !=-1) {// MWL09022022 
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field  w3-padding-48 ' style='  object-fit: scale-down'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0682/8923/3182/files/DTGGucciMIY.png?v=1680319971'    />");                                              

    } else if (MonogramFont.indexOf("DTGPillow")  !=-1) {// MWL09022022 
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field  w3-padding-48 ' style='  object-fit: scale-down'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0682/8923/3182/files/DTGPillowLightPink.png?v=1690899910'    />");                                              
  ...
  function GenerateMonogram() {
    ...
    if (MonogramFont.indexOf("DTGPillow") != -1) {
          MonogramText = $('input#MonogramText1').val();
    ...
    //-----------------------------------
    if (MonogramText !== "" && threadcolor !== "" && typeof threadcolor !== 'undefined' && MonogramText1 !== "" && threadcolor1 !== "" && typeof threadcolor1 !== 'undefined' && MonogramFont !== "" && typeof MonogramFont !== 'undefined') {
      ...
      if (MonogramFont.indexOf("DTG") != -1) {  //all BigPrints DTG will go here unless have special info          
        ...
        if (MonogramFont.indexOf("DTGGucciMIY") != -1) {
              threadcolor = "Acfb98a";
        ...
        } else if (MonogramFont.indexOf("DTGPillow") != -1) { 
      ...
      if (flagStop != "1") {       //------------------2 Letter
        ...
        firstMonoLink = "https://" + mono_server + ".com/ecs/api/ecs/7?sku=" + MonogramFont + "&style=" + logoColor + "&pers1=" + MonogramText1 + "&color1=" + threadcolor1+ "&pers2=" + MonogramText + "&color2=" + threadcolor;
      ...
      if (MonogramText == "") {
        errorDetails = "input your Text";
        $("#MonogramText").attr('disabled', false);
      } else if (threadcolor == "") {
        errorDetails = "select a Threadcolor";
      } else if (MonogramText1 == "") {
        errorDetails = "input your Monogram";
        $("#MonogramText1").attr('disabled', false);
      } else if (threadcolor1 == "") {
        errorDetails = "select a Threadcolor";
      } else {
  ...
  function addDivclassUserAgreement() {  //replacing the code due to typo error
    ...
    $('#uaID').on('change', function () {
      ...
      } if ((this.checked) && flagStop != "1" && MonogramText1 != "") {
        $('#btn add-to-cart').prop('disabled', false);
  ...
  $("#btnClose").click(function () {
    ...
    $("#threadcolor1 option:selected").attr('selected', false).first().attr('selected', true);
