   ...
   //-----------------------------------
    ...
    MonogramText =  MonogramText_EMB1; //Pass the DTG text to EMB for same monogram
      ...
      if (MonogramText  !== "" &&  threadcolor !== ""  && typeof threadcolor !== 'undefined'  &&  MonogramFont !== "" && typeof MonogramFont !== 'undefined')   {
 			...
 			//--- This line of code is for EMBLoungeSet101M From Window1 Font selected is cascaded to the second  
           if (MonogramFont.indexOf("LoungeSet101MFont") !=-1) { //for all Lounge Set 101 both
      		MonogramFont =  MonogramFont_EMB1; //Pass the Font of EMB1  to EMB for same monogram
      		}
        	//---
