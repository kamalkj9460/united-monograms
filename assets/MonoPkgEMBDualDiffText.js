...
$(function () {
  ...
  $("#preview-monogram").on("click", function (el) {
    ...
    MonogramFont_EMB1 = $('select[name="properties[Monogram Style_EMB1]"]')
      .find(":selected")
      .attr("data-valname");
    ...
    //--------------------------------------------
    if (MonogramFont_EMB1.indexOf("76m") != -1) {
      $("#EMB1monogramimage").html(
        "<img id='EMB1monogramImg'   class='line-item-property__field  w3-padding-48 ' style='  object-fit: scale-down'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0635/8561/files/ABC_white.png?11804'   />"
      );
    } else {
      $("#EMB1monogramimage").html(
  ...
  function GenerateMonogram_EMB1() {
    ...
    //EMB1 Display
    MonogramText_EMB1 = $("input#MonogramText_EMB1").val();
    threadcolor_EMB1 = $("#threadcolor_EMB1 option:selected").attr(
      "data-valcolor"
    );
    MonogramFont_EMB1 = $('select[name="properties[Monogram Style_EMB1]"]')
      .find(":selected")
