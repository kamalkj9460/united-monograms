...
function GenerateMonogram()
{
  ...
  if (MonogramText  !== "" &&  threadcolor !== ""  && typeof threadcolor !== 'undefined'  &&  MonogramFont !== "" && typeof MonogramFont !== 'undefined')   {
     ...
     //For Monograms without Logo Colors but requires Custom Colors
      if (MonogramFont.indexOf("Patchapp") != -1) {  //MWL08062021 
              MonogramFont1 ="Patchapp2";
              MonogramFont2 ="Patchapp2";  
      ...
      //extract png file working
                   ...
                   $.get(Mono1_PckgLink, function(data, status){
                            sendImg = ("https://"+data);
                              ...
                              $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field    w3-padding-48 ' style='  object-fit: fill'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0054/6819/2886/files/LetterPatchStatic.jpg?v=1647934457'    />");  
...
$('select[name="properties[Letter Patch Style]"] option').attr('selected', false).first().attr('selected', true);
