...
$(function() {
  ...
  $('#preview-monogram').on('click', function(el) {
    ...
    if (MonogramFont.indexOf("DTGDunkinHappy") !=-1) {// MWL02/17/2022  
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field    w3-padding-48 ' style='  object-fit: fill'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0054/6819/2886/files/DTGTargetHappy.png?v=1645791320'    />");

    } else if (MonogramFont.indexOf("DTGDiego") !=-1) {// MWL02/17/2022  
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field    w3-padding-48 ' style='  object-fit: fill'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0054/6819/2886/files/DTGDiego.png?v=1645791291'    />");

    } else if (MonogramFont.indexOf("DTGNYC") !=-1) {// MWL02/17/2022  
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field    w3-padding-48 ' style='  object-fit: fill'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0054/6819/2886/files/DTGNYC.png?v=1645791312'    />");

    } else if (MonogramFont.indexOf("DTGNash") !=-1) {// MWL02/17/2022  
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field    w3-padding-48 ' style='  object-fit: fill'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0054/6819/2886/files/DTGNashBlack.png?v=1645791301'    />");

    } else if (MonogramFont.indexOf("DTGSmile") !=-1) {// MWL02/17/2022  
      $("#monogramimage").html("<img id='monogramImg'   class='line-item-property__field    w3-padding-48 ' style='  object-fit: fill'    alt='Monogram here'  src='//cdn.shopify.com/s/files/1/0054/6819/2886/files/DTGSmileBlock.png?v=1646992840'    />");
  ...
  function GenerateMonogram()
  {
    ...
    if (NonMonogramFont.slice(-2) == "no") {
      MonogramText = "***";
      $("#MonogramText").val('');
    } else if (NonMonogramFont.slice(-3) != "cir") {
      MonogramText = "**";
      $("#MonogramText").val('');
    } else if (NonMonogramFont.slice(-5) != "block") {
      MonogramText = "**";
      $("#MonogramText").val('');
    } else if (NonMonogramFont.slice(-4) != "vine") {
      MonogramText = "**";
      $("#MonogramText").val('');
    } else if (NonMonogramFont.slice(-4) != "bold") {
      MonogramText = "**";
      $("#MonogramText").val('');
    } else if (NonMonogramFont.indexOf("DTG2") !=-1) {
      MonogramText = "**";
      $("#MonogramText").val('');
    } else {
      MonogramText = $('input#MonogramText').val();
  ...
  //----UserAgreement changed 06/26 #JDG  -----End        
    ...
    $("#btnClose").click(function () {
        ...
        $('select[name="properties[Your Pick]"] option').attr('selected', false).first().attr('selected', true);
